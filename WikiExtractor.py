...
def get_argparser():
    ...
    parser.add_argument('--infn', type=str, required=False, help="The location/file of the Wiki Dump. Supports uncompressed, bz2, and gzip.",default="/Volumes/My Passport for Mac/00_nlp/enwiki/enwiki.xml.bz2")
...
if __name__ == '__main__':
    ...
    python -m wikiextractor.WikiExtractor "/Volumes/My Passport for Mac/00_nlp/enwiki/enwiki.xml.bz2"
    """